...
const FAQ: [string, string][] = [
  ...
  ["Why are my chats 'offline demo' quality?", "Live models aren't connected on this deployment yet. Offline mode still answers maths, conversions and code, and image, voice and web search all work normally. To unlock full quality on your account, connect your own key in Settings → API keys — it's encrypted and used only for you."],
