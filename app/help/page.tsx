...
const FAQ: [string, string][] = [
  ...
  ["Why are my chats 'offline demo' quality?", "The platform's live models need provider keys on the server. Drop your own free Groq key in Settings → API keys — instantly powers your Chat, Code, and Vision (encrypted, only for you)."],
